...
if __name__ == "__main__":
    ...
    parser.add_argument('--samples_path',
                        default='../../Results/validation_results/',
                        type=str,
                        help="Relative path to parameter samples")

    parser.add_argument('--samples_file',
                        default='validation_posterior_samples.npy',
                        type=str,
    ...
    # save real data
    if sim_id == 0:
        val_data_last_day = 30
        data = np.empty((val_data_last_day, 2))
        data[:, 0] = infected_total_state[day_index+1:(day_index + val_data_last_day+1):1]
        data[:, 1] = deceased_state[day_index+1:(day_index + val_data_last_day+1):1]
