...
if __name__ == "__main__":
    ...
    infected_total_state = np.loadtxt(data_path + 'covid_25June2020/infected_total_state.txt')
    deceased_state = np.loadtxt(data_path + 'covid_25June2020/deceased_state.txt')
    ...
    p_mode = np.array([400, 3.3e-4, 4.35e-6, 1./24., 1./160., 1./7., 4*1.16])
